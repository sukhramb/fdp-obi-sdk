 ...
 */
@Validated
public class OBGenericResponse {
    @JsonProperty("Data")
    ...
    public OBGenericResponse data(String data) {
        this.data = data;
        return this;
    }
    ...
    public OBGenericResponse links(Links links) {
        this.links = links;
        return this;
    }
    ...
    public OBGenericResponse meta(Meta meta) {
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        OBGenericResponse obWriteDomesticResponse2 = (OBGenericResponse) o;
